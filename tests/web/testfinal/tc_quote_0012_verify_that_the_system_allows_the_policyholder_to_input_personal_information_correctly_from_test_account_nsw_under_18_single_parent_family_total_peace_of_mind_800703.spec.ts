...
test('Get Quote TH', { tag: ["@testfinal"] }, async ({ page }, testInfo) => {
...
await allure.step("Click Under 18 : ", async() =>{ await page.locator('xpath=/html[1]/body[1]/div[2]/div[2]/main[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[2]/div[1]/a[1]/div[1]/span[1]').waitFor({state:"visible"}); await page.locator('xpath=/html[1]/body[1]/div[2]/div[2]/main[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[2]/div[1]/a[1]/div[1]/span[1]').click();});

await allure.step("Click single parent family : ", async() =>{ await page.locator('xpath=/html[1]/body[1]/div[2]/div[2]/main[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/div[2]/div[1]/a[4]/div[1]').waitFor({state:"visible"}); await page.locator('xpath=/html[1]/body[1]/div[2]/div[2]/main[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/div[2]/div[1]/a[4]/div[1]').click();});

await allure.step("Click Total peace of mind : ", async() =>{ await page.locator('xpath=/html[1]/body[1]/div[2]/div[2]/main[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[4]/div[2]/div[1]/a[2]/div[1]/span[1]').waitFor({state:"visible"}); await page.locator('xpath=/html[1]/body[1]/div[2]/div[2]/main[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[4]/div[2]/div[1]/a[2]/div[1]/span[1]').click();});
...
await allure.step("Enter Number : 412345678", async() =>{ await page.locator('xpath=/html[1]/body[1]/div[2]/div[2]/main[1]/div[1]/div[1]/div[2]/form[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/input[1]').waitFor({state:"visible"}); await page.locator('xpath=/html[1]/body[1]/div[2]/div[2]/main[1]/div[1]/div[1]/div[2]/form[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/input[1]').click(); await page.locator('xpath=/html[1]/body[1]/div[2]/div[2]/main[1]/div[1]/div[1]/div[2]/form[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/input[1]').pressSequentially('412345678');});
...
await allure.step("Click has cover : N", async() =>{ await page.locator('//*[contains(@id, "no")]').waitFor({state:"visible"}); await page.locator('//*[contains(@id, "no")]').click();});
