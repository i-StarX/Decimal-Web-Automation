...
test('TC_AP_013 Verify the Function Code search option is working for vaild inputs', { tag: ["@regression_web", "@organization_management", "@function", "@TC_AP_013"] }, async ({ page }) => {
...
await expect(page.getByRole('cell', {name : 'HR12'})).toBeVisible();
