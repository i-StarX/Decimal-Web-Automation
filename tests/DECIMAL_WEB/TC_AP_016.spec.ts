...
test('TC_AP_016 Verify the Function Name search option is working for invaild inputs', { tag: ["@regression_web", "@organization_management", "@function", "@TC_AP_016"] }, async ({ page }) => {
