...
test('TC_AP_002 Verify that "Function" module Page is working', { tag: ["@regression_web", "@organization_management", "@function", "@TC_AP_002"] }, async ({ page }) => {
...
await expect(page.locator('//*[text()="Organization Management"]/ancestor::*[contains(@class, "section-one")]//*[text()="Function"]')).toBeEnabled();
