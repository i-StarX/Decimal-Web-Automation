...
test('TC_AP_015 Verify the Function Name search option is working for vaild inputs', { tag: ["@regression_web", "@organization_management", "@function", "@TC_AP_015"] }, async ({ page }) => {
...
await expect(page.getByRole('cell', {name : 'HirirngDept'})).toBeVisible();
