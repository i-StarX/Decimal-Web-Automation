...
test('TC_AP_009 Verify the "Employee" sub-module redirection', { tag: ["@regression_web", "@organization_management", "@employee", "@TC_AP_009"] }, async ({ page }) => {
...
await expect(page).toHaveURL(/\/org-management\/employee/);
