...
test('deleteProductSubVariant', { tag: ["@regression_apiDecimal"] }, async ({ request }) => {
...
module_2: "delete"
    ...
    "code": "RASHTST14"
        ...
        apiResponse.body().then(body => {
            let expected = '{    "ADMIN_PORTAL_API": {        "records": [            {                "primary_key": "",                "data": [                    {                        "status": "success",                        "success": {                            "code": "200",                            "message": "User Details Deleted"                        }                    }                ]            }        ],        "responseHandledBy": "MOBILE APP",        "isSuccessRuleValidated": true    }}';
